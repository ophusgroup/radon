...
"""
TODO: Unsure what the different between Volume2D and Volume3D is.

Potentially, Volume3D is only needed for ConeBeam or FanBeam projection methods, but those
